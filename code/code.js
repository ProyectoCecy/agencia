...
function opciones() {
    const opciones = document.querySelector('.dropdown-content');
    const ajustesBtn = document.querySelector('.dropbtn');

    if (opciones.style.display === "block") {
        /* AQUI VERIFICA SI ESTA ESCONDIDO LOS ELEMENTOS QUE APARECEN DE COMPRAS, CARRITO Y CUENTA */
        ...
        /* DEL CASO CONTRARIO SI SE ESTA MOSTRANDO LOS ELEMENTOS DE COMPRAS, CUENTA Y CARRITO, ENTONCES SE MOSTRARA LOS ELEMTNOS ANTERIORES */
